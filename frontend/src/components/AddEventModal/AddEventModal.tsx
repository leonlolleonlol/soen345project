...
export function AddEventModal({ onClose, onCreated }: Props) {
  const { currentUser } = useUser()
  const [form, setForm] = useState<Omit<CreateEventForm, 'createdBy'>>(BASE_FORM)
  ...
  function set<K extends keyof CreateEventForm>(key: K, value: CreateEventForm[K]) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null)
    try {
      const created = await createEvent({ ...form, createdBy: currentUser!.userId })
      onCreated?.(created)
      onClose()
    } catch (err) {
    ...
    <div className="modal-backdrop" ref={backdropRef} onClick={handleBackdropClick}>
      <div className="modal" role="dialog" aria-modal="true" aria-labelledby="modal-title">
        <div className="modal-header">
          <h2 id="modal-title" className="modal-title">Add Event</h2>
          ...
          <div className="modal-row">
            <div className="modal-field">
              ...
              <input
                ...
                onChange={e => set('availableTickets', Number(e.target.value))}
              />
            </div>
          ...
          <div className="modal-row">
            ...
            <div className="modal-field">
              ...
              <input
                ...
                onChange={e => set('venueCapacity', Number(e.target.value))}
              />
            </div>
          </div>
